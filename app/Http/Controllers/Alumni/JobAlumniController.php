...
class JobAlumniController extends Controller
{
    public function index()
    {
        ...
        return view('pages.alumni.job', compact('lowongans'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Redirect or respond as needed
        return redirect()->route('job')->with('success', 'Lowongan updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        // Redirect or respond as needed
        return redirect()->route('job')->with('success', 'Lowongan deleted successfully.');
    }
