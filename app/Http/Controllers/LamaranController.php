...
class LamaranController extends Controller
{
    public function store(Request $request)
    {
        ...
        $transkripPath = $request->file('transkrip_nilai') ? $request->file('transkrip_nilai')->store('uploads/transkrip') : null;
        $portofolioPath = $request->file('portofolio') ? $request->file('portofolio')->store('uploads/portofolio') : null;
